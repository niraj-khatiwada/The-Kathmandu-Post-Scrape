...
class Django():
    ...
    def run_server(self):
        run_server = subprocess.run(
            "cd C:/Users/niraj/Documents/Projects/Scraping Kathmandu Post/The_Kathmandu_Post_Scrape && python manage.py runserver", stderr=subprocess.STDOUT, shell=True)
...
class Scrapy():
    ...
    def crawl_spider(self):
        crawl_spider = subprocess.run(
            "cd C:/Users/niraj/Documents/Projects/Scraping Kathmandu Post/The_Kathmandu_Post_Scrape/kathmandu_post && scrapy crawl the_kathmandu_post", stderr=subprocess.STDOUT, shell=True)
